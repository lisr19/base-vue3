(function webpackUniversalModuleDefinition (root, factory) {
  if (typeof exports === 'object' && typeof module === 'object') { module.exports = factory(require('../viewerjs/viewer.js'), require('vue')) } else if (typeof define === 'function' && define.amd) { define(['../viewerjs/viewer.js', 'vue'], factory) } else if (typeof exports === 'object') { exports['VueViewer'] = factory(require('../viewerjs/viewer.js'), require('vue')) } else { root['VueViewer'] = factory(root['Viewer'], root['Vue']) }
    ...
    /***/ function (module, __webpack_exports__, __webpack_require__) {
      ...
      /* WEBPACK VAR INJECTION */(function (global) {
        ...
        var directive = function directive () {
          ...
          var name = _ref$name === undefined ? 'viewer' : _ref$name
